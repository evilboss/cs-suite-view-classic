    ...
    <div class="row">
        ...
        function humanTiming($time)
        {
            ...
            if ($time_difference >= 60 * 60 * 24 * 365.242199)
            {
                 ...
                 */
                return get_time_ago_string($time, 60 * 60 * 24 * 365.242199, 'year');
            }
            elseif ($time_difference >= 60 * 60 * 24 * 30.4368499)
            {
                 ...
                 */
                return get_time_ago_string($time, 60 * 60 * 24 * 30.4368499, 'month');
            }
            elseif ($time_difference >= 60 * 60 * 24 * 7)
            {
                 ...
                 */
                return get_time_ago_string($time, 60 * 60 * 24 * 7, 'week');
            }
            elseif ($time_difference >= 60 * 60 * 24)
            {
                 ...
                 */
                return get_time_ago_string($time, 60 * 60 * 24, 'day');
            }
            elseif ($time_difference >= 60 * 60)
            {
                 ...
                 */
                return get_time_ago_string($time, 60 * 60, 'hour');
            }
            else
            {
                /*
                 ...
                 */
                return get_time_ago_string($time, 60, 'minute');
            }
        }
        ...
        function get_time_ago_string($time_stamp, $divisor, $time_unit)
        {
            ...
            else
            {
                ...
                return abs($time_units) . ' ' . $time_unit . 's ago';
            }
...
//$time_in_12_hour_format  = date("g:i a", strtotime($time_formatted));
            ...
            $time_passed = humanTiming($time_to_be_calculated);
            return $time_passed;
            if ($time_passed == NULL) {
